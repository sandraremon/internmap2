        ...
        <>
            ...
            {// @ts-ignore
                selectedKey == "Roadmaps" ? (
                    <>
                        {sortedRoadmaps.length != 0 && (<div style={{display: "flex", flexDirection: "row", gap: "10px", alignItems: "center"}}>
                                ...
                                <Disclosure isExpanded={isRecentsExpanded}>
                                    <Disclosure.Content className="overflow-visible">
                                        <Disclosure.Body className="overflow-visible">
                                            ...
                                            <div className="container-padded" style={{display: "grid", justifyContent: "center", gridTemplateColumns: "repeat(auto-fit, minmax(285px, 1fr))", gap: "50px", borderRadius: "65px"}}>
                                                {recentRoadmaps.map((roadmap: Roadmap) => (
                                                    <div style={{cursor: "pointer"}} onClick={() => location.href = `/roadmaps/${roadmap.id}`} className="roadmap-button min-w-72" key={roadmap.id} >
                                                        <a>
                                                            {roadmap.name}
                                                        </a>
                                                    </div>
                ...
                <div className="flex flex-col items-center justify-center gap-20 pl-10 pr-10 pt-10">
                    ...
                    {sortedJobPostings.map((posting: job) => (
                        <div key={posting.id.toString()} className="container-full-width" style={{padding: "25px"}}>
                            <div className="flex justify-between items-center">
                                ...
                                <div style={{padding: '4px 12px', background: 'linear-gradient(180deg, rgba(8, 109, 250, 0.8) 0%, rgba(27, 155, 254, 0.9) 100%)', borderRadius: 75, outline: '2px rgba(255, 255, 255, 0.20) solid', outlineOffset: '-2px', backdropFilter: 'blur(20px)', alignItems: 'center', justifyContent: 'center',}}>
                                ...
                                {posting.type == "FullTime" && (
                                    <div style={{padding: '4px 12px', background: 'linear-gradient(180deg, rgba(254, 27, 84, 0.8), rgba(251, 8, 8, 0.9))', borderRadius: 75, outline: '2px rgba(255, 255, 255, 0.20) solid', outlineOffset: '-2px', backdropFilter: 'blur(20px)', alignItems: 'center', justifyContent: 'center',}}>
                                <span style={{ color: 'white', fontSize: 13, fontFamily: 'Inter', fontWeight: '800', whiteSpace: 'nowrap' }}>
                                    <a href={`/postings/${posting.id}`}>
                                        {posting.type}
                                    </a>
                                ...
                                {posting.type == "FreeLanceProject" && (
                                    <div style={{padding: '4px 12px', background: 'linear-gradient(180deg, rgba(254, 126, 27, 1), rgba(251, 128, 8, 1))', borderRadius: 75, outline: '2px rgba(255, 255, 255, 0.20) solid', outlineOffset: '-2px', backdropFilter: 'blur(20px)', alignItems: 'center', justifyContent: 'center',}}>
                                <span style={{ color: 'white', fontSize: 13, fontFamily: 'Inter', fontWeight: '800', whiteSpace: 'nowrap' }}>
                                    <a href={`/postings/${posting.id}`}>
                                        Freelance
                                    </a>
                            ...
                            <div>
                                <div className="text-xl font-bold mb-0.5" key={posting.id}>
                            ...
                            <hr className="mt-3.5 mb-3.5 rounded-full border-2" style={{borderColor: "var(--component-quaternary)"}}/>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex gap-2 items-center align-middle">
                                    <Button variant="secondary" isIconOnly style={{width: 40, height: 40}}>
                                        <img className="theme-adaptive-icon" style={{ width: 16 }} src="/images/assets/arrow.up.left.and.arrow.down.right@4x.png" alt="expand"/>
                                    </Button>
